...
insert into test2 (name,age) values ('홍길동',default);
insert into test2 (name,age) values ('홍길동');
...
insert into test2 values (default,'소나무',55,default,'서울');
insert into test2 values (default,'오하늘',39,'여자','서울');
insert into test2 values (default,'이전말',44,'남자','광주');
insert into test2 values (default,'가나다',50,'남자','제주');
insert into test2 values (default,'고진감',85,'남자','울산');
insert into test2 values (default,'이지은',19,'여자','청주');
insert into test2 values (default,'김화사',32,'여자','진안');
...
-- name필드명을 irum으로 변경하시오 -- change column
